...
# [[Configuration]]
For initial version no configuration means (other than constants in the source); for [[v0.3.x]] or something we should have that. At the very least we'd want configuration for the edge thresholds
